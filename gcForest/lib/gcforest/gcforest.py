...
from gcForest.lib.gcforest.cascade.cascade_classifier import CascadeClassifier
from gcForest.lib.gcforest.config import GCTrainConfig
from gcForest.lib.gcforest.fgnet import FGNet
from gcForest.lib.gcforest.utils.log_utils import get_logger
...
class GCForest(object):
    ...
    def fit_transform(self, X_train, y_train, X_test=None, y_test=None, train_config=None):
        ...
        if self.ca is not None:
            _, X_train, _, X_test, _, = self.ca.fit_transform(X_train, y_train, X_test, y_test,
